...
> See full PDF at: [https://dev.z3nth10n.net/dev/assets/getassetpreview/manuals/README.pdf](https://dev.z3nth10n.net/dev/assets/uzlib.lite/manuals/README.pdf)
...
Need help? Just clone [this repository](https://github.com/uta-org/uzLib.Lite) into your Unity project or in your solution.

For documentation, just check the [Documentation API](http://dev.z3nth10n.net/dev/assets/uzlib.lite/docs).

## Issues

Having issues? Just report in [the issue section](https://github.com/uta-org/uzLib.Lite/issues). **Thanks for the feedback!**

## Contribute

Fork [this repository](https://github.com/uta-org/uzLib.Lite), make your changes and then issue a pull request. If you find bugs or have new ideas that you do not want to implement yourself, file a bug report.
